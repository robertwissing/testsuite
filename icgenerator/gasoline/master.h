...
void msrCalcPmFactor(MSR, double, double *);
void msrUpdateBDot(MSR,double);
void msrISPHInvertMatrix(MSR);
void msrUpdateDensity(MSR);
void msrICGetFmax(MSR,double *);
void msrICNormalizeFmax(MSR,double);
void msrICNormalizeVel(MSR);
...
void msrCalcEandL(MSR,int,double,double *,double *,double *,double *,double *,double *,double *,double *,
