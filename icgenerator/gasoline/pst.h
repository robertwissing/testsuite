...
struct inKick {
    ...
    double z;
    double dTimeEnd;
	int bOpen;				/* for gas patch */
	double dOrbFreq;		/* for gas patch */
    UHC uhc;
  double ICR0; /* setting maximum displacement */
	};
struct outKick {
	double Time;
	double MaxTime;
...
/* PST_CALCPMFACTOR */
struct outCalcPmFactor {
  double kinviscAvg;
  double etaresAvg;
};
void pstCalcPmFactor(PST,void *,int,void *,int *);

void pstUpdateBDot(PST,void *,int,void *,int *);
...
/* PST_ICNORMALIZEFMAX */
struct outICNormalizeFmax {
  double fmaxnorm;
};
void pstICGetFmax(PST,void *,int,void *,int *);

void pstICNormalizeFmax(PST,void *,int,void *,int *);

void pstICNormalizeVel(PST,void *,int,void *,int *);
